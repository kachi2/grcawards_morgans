...
class CreateComBankRiskComplaincesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('com_bank_risk_complainces', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('com_bank_risk_complainces');
    }
}
