        ...
        <div class="col-3">
            <div class="card" style="width: 20rem;">
                <div class="card-body">
                  ...
                  @endphp
                  <a href="{{route('admin.load_judge_category_sector_page_results', [request()->segment(3), $category->hashid])}}" class="btn btn-primary"> {{count($category->sectors)}} Sectors - View All </a>
                </div>
              </div>
        </div>    
        @endforeach
