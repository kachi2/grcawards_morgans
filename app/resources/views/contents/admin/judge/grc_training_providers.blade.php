                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{route('admin.getNominessDetails',[request()->segment(3)])}}"  id="form1">
                        ...
                        <div class="row" id="create-form-row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="control-label form-label">Profile of the training provider and areas of grc covered</label>
                                    <input class="form-control @error('profile_of_the_training_provider_and_areas_of_grc_covered') is-invalid @enderror"  @if(isset($nominessDetails->profile_of_the_training_provider_and_areas_of_grc_covered)) value="{{$nominessDetails->profile_of_the_training_provider_and_areas_of_grc_covered}}" @endif placeholder="profile of the training provider and areas of grc covered" type="text" name="profile_of_the_training_provider_and_areas_of_grc_covered"  />
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="control-label form-label">Evidence of innovative ways of teaching</label>
                                    <input class="form-control @error('evidence_of_innovative_ways_of_teaching') is-invalid @enderror"  @if(isset($nominessDetails->evidence_of_innovative_ways_of_teaching)) value="{{$nominessDetails->evidence_of_innovative_ways_of_teaching}}" @endif placeholder="evidence of innovative ways of teaching" type="text" name="evidence_of_innovative_ways_of_teaching"  />
                                   
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="control-label form-label">Clients of training providers</label>
                                    <input class="form-control @error('clients_of_training_providers') is-invalid @enderror" @if(isset($nominessDetails->clients_of_training_providers)) value="{{$nominessDetails->clients_of_training_providers}}" @endif placeholder="clients of training providers" type="text" name="clients_of_training_providers"  />
                                   
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="control-label form-label">Clients rating of training provider</label> 
                                    <input class="form-control @error('clients_rating_of_training_provider') is-invalid @enderror" @if(isset($nominessDetails->clients_rating_of_training_provider)) value="{{$nominessDetails->clients_rating_of_training_provider}}" @endif  placeholder="clients rating of training provider" type="text" name="clients_rating_of_training_provider"  />
