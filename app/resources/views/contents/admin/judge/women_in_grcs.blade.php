                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{route('admin.getNominessDetails',[request()->segment(3)])}}"  id="form1">
                        ...
                        <div class="row" id="create-form-row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="control-label form-label">Company and linkedin profile link</label>
                                    <input class="form-control @error('Company_and_linkedin_profile_link') is-invalid @enderror"  @if(isset($nominessDetails->Company_and_linkedin_profile_link)) value="{{$nominessDetails->Company_and_linkedin_profile_link}}" @endif placeholder="Company_and_linkedin_profile_link" type="text" name="Company_and_linkedin_profile_link"  />
                                </div>
                            </div>
